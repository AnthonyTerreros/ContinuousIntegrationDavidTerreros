...
public class RestaurantCalculator {
	...
	public RestaurantCalculator() {
		...
		this.dinerNames = new ArrayList<>(Arrays.asList("Yapinyacho", "Encebollado", "Arroz con Pollo", "Lasaña", "Bolon Mixto", "Cangrejada de Infarto (20 Krabs)"));
	...
	public int getAmountTotal() {
		int total = this.userOrdersSelected.stream()
	...
	private void showMessage(int res, int... idDinnerUserSelected) {
		...
		if(res == -4) {
			System.out.println("The Id Dinner is already selected. Please go to Change Amount of Dinner for update dinner. \n");
		}
		if(res == -5) {
